...
import com.panta.cryptobot.dependency.domain.event.*;
...
public interface BinanceApiWebSocketClient extends Closeable {
     ...
     */
    Closeable onDepthEvent(String symbols, com.panta.cryptobot.dependency.BinanceApiCallback<DepthEvent> callback);
     ...
     * @return a {@link Closeable} that allows the underlying web socket to be closed.
     */
    Closeable onCandlestickEvent(String symbols, CandlestickInterval interval, com.panta.cryptobot.dependency.BinanceApiCallback<CandlestickEvent> callback);
     ...
     * @return a {@link Closeable} that allows the underlying web socket to be closed.
     */
    Closeable onAggTradeEvent(String symbols, com.panta.cryptobot.dependency.BinanceApiCallback<AggTradeEvent> callback);
     ...
     * @return a {@link Closeable} that allows the underlying web socket to be closed.
     */
    Closeable onUserDataUpdateEvent(String listenKey, com.panta.cryptobot.dependency.BinanceApiCallback<UserDataUpdateEvent> callback);
     ...
     * @return a {@link Closeable} that allows the underlying web socket to be closed.
     */
    Closeable onTickerEvent(String symbols, com.panta.cryptobot.dependency.BinanceApiCallback<TickerEvent> callback);
     ...
     * @return a {@link Closeable} that allows the underlying web socket to be closed.
     */
    Closeable onAllMarketTickersEvent(com.panta.cryptobot.dependency.BinanceApiCallback<List<TickerEvent>> callback);
     ...
     * @return a {@link Closeable} that allows the underlying web socket to be closed.
     */
    Closeable onBookTickerEvent(String symbols, com.panta.cryptobot.dependency.BinanceApiCallback<BookTickerEvent> callback);
     ...
     * @return a {@link Closeable} that allows the underlying web socket to be closed.
     */
    Closeable onAllBookTickersEvent(com.panta.cryptobot.dependency.BinanceApiCallback<BookTickerEvent> callback);
