package com.panta.cryptobot.dependency.domain.market;
...
public class Candlestick {
  ...
  public BigDecimal getHighFormatted() {
    return new BigDecimal(high);
  }

  public BigDecimal getVolumeFormatted() {
    return new BigDecimal(volume);
  }

  public Double getCloseFormatted() {
    return Double.valueOf(close);
  }

  public Double getOpenFormatted() {
