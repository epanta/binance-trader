...
import com.panta.cryptobot.dependency.BinanceApiSwapRestClient;
import com.panta.cryptobot.dependency.constant.BinanceApiConstants;
import com.panta.cryptobot.dependency.domain.SwapRemoveType;
...
import static com.panta.cryptobot.dependency.impl.BinanceApiServiceGenerator.executeSync;

/**
 * Implementation of Binance's SWAP REST API using Retrofit method calls.
 */
public class BinanceApiSwapRestClientImpl implements com.panta.cryptobot.dependency.BinanceApiSwapRestClient {
